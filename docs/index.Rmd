...
## Suggested Methodological Steps
...
4. Presentation of Management Strategy Evaluation Results


## Installation

Following testing, application and review, the short-lived tools will included in the MSEtool package of the OpenMSE libraries. Until then they can be installed from the SLtools library: 


## Specifying Seasonal Operating Models for Simulating Data

### A single species, single fleet model with age-specific distribution and seasonal recruitment

### A Growth-Type-Group model with single fleet dynamics

## Simulation Testing Assessment Models
...
Funding support for this project was provided by The Pew Charitable Trusts. However, the views expressed herein are those of the authors and do not necessarily reflect the views of The Pew Charitable Trusts.
